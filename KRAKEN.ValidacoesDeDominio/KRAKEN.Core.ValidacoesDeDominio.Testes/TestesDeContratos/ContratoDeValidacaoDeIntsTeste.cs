...
{
    public class ContratoDeValidacaoDeIntsTeste
    {
        [Xunit.TraitAttribute("Categoria", "Testes de Contrato de Int")]
        ...
        public void DeveRetornarNotificaoQuandoValorForNuloOuNullable()
        {
            ...
            entidadeTeste.NullableIntProp = null;

            var contrato = new Contrato();

            contrato.Requer()
                .VerificarSeEstaNulo(entidadeTeste.NullableIntProp,
        ...
        {
            var entidadeTeste = new EntidadeDeTiposTeste();
            entidadeTeste.NullableIntProp = 400;
